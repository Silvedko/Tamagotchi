...
{
	public class AbstractCharacteristic : MonoBehaviour, ICharacteristic 
	{
		...
		public float CharacteristicValue
		{
			...
			set 
			{
				...
				if (charValue > GameConstants.maxCharacteristicSliderValue) 
				{
					...
					Debug.LogWarning ("Value is max, stop clicking!");
				}
		...
		public void EnableAccessToAddButton (bool isAccessed)
		{
		...
		protected virtual void SetSliderDefaultValues ()
		{
			GetUISlider ();
		...
		protected virtual void SetCharacteristicDefaultValue ()
		{
